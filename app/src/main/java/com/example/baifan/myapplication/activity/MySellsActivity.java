        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    // 打开链接
                    String url = "http://111.231.101.251:8080/fuwuduan/sellerOrders.jsp?account="+acc1+"&isfinish="+is;
                    // 发送消息
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    String acc1 = URLEncoder.encode(acc, "UTF-8");
                    // 打开链接
                    String url = "http://111.231.101.251:8080/fuwuduan/sellerOrders.jsp?account="+acc1;
                    // 发送消息
                    Message msg = new Message();
                    msg.what = MYREADALL;
                    msg.obj = HttpUtils.connection(url).toString();
